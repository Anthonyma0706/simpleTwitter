...
public class Test {
    public static void main(String[] args){
        MyHashTable<String,Integer> myHashTable = new MyHashTable(7);
        myHashTable.put("0", 11);
        myHashTable.put("sds", 11111);
        myHashTable.put("asdas", 3);
        myHashTable.put("d", 4);
        myHashTable.put("z", 5);
        myHashTable.put("b", 6);
        myHashTable.put("a", 7);
       // myHashTable.remove("a");
        //myHashTable.remove("ah");
        //myHashTable.remove("cass");
        //System.out.println(myHashTable.getBuckets());
       // System.out.println(MyHashTable.slowSort(myHashTable));
     //   System.out.println(MyHashTable.fastSort(myHashTable));

        Tweet t1 = new Tweet("Andy", "2020-04-06 19:30:20", "First test");
        Tweet t2 = new Tweet("Bob", "2020-04-06 19:30:20", "2 test");
        Tweet t3 = new Tweet("Cow", "2020-02-06 19:30:20", "3 test");
        Tweet t4 = new Tweet("David", "2020-01-06 19:30:20", "4 test");
        Tweet t5 = new Tweet("Eric", "2020-05-06 19:30:20", "5 test");
        Tweet t6 = new Tweet("Cow", "2020-08-06 19:30:20", "newwww test");
        Tweet t7 = new Tweet("Cow", "2020-08-07 19:30:20", "abc test");
        ArrayList<Tweet> tweetList1 = new ArrayList<>();
        tweetList1.add(t1);
        tweetList1.add(t2);
        tweetList1.add(t3);
        tweetList1.add(t4);
        ...
        tweetList1.add(t6);
        tweetList1.add(t7);
        Twitter twitter1 = new Twitter(tweetList1, null);
        ...
        //tweets.add(new Tweet("USER_989b85bb","2010-03-04 15:34:46","@USER_6921e61d I can be made into one twitter superstar."));
        Twitter twitter2 = new Twitter(tweets, null);

        System.out.println(twitter2.trendingTopicsTest().get(" "));


        /*System.out.println(twitter1.totalTweetList.size());
        System.out.println(twitter1.tweetsByDate("2020-04-06"));
        System.out.println(twitter1.tableByDate.get("2020-04-06"));
        System.out.println(Twitter.getWords(t1.getMessage()).contains("nb"));*/
